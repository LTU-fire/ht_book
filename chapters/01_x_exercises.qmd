...
$$
R_{tot} = R_{in} + R_{s} + R_{i} + R_{o} = \frac{1}{2\pi}\left(\frac{1}{r_i h_{in}} + \frac{\ln\left(r_{o,s}/r_{i,s}\right)}{\lambda_{s}} + \frac{\ln\left(r_{o,i}/r_{i,i}\right)}{\lambda_{i}} + \frac{1}{r_{o,i} h_{out}}\right) \approx 0.41 \text{ } m²K/W
$$
